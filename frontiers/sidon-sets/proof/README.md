# Additive combinatorics: Sidon sets and N(h,k) bounds packet
...
- Project: Additive combinatorics: Sidon sets and N(h,k) bounds
- Compiled at: 2026-05-09T19:20:04Z
- Generated at: 2026-06-17T14:43:12.000805+00:00
- Compiler: vela/0.75.0
- Vela version: 0.10.0
...
- `artifacts/artifacts.json`: content-addressed protocols, files, records, and dataset manifests
...
- `source-integrity/source-debt.json`: derived queue of missing source locators, evidence locators, and content hashes
- `reviewer/`: reviewer sections for source debt, trace provenance, graph navigation, score ledger, correction returns, freshness, and `reviewer/replay-manifest.json`
...
- Findings in source frontier: 40
- High-signal findings exported: 39
- Gap findings exported: 0
- Contested findings exported: 1
- Bridge entities exported: 0
